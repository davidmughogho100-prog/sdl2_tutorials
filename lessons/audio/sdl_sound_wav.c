...
int main()
{
   ...
   // 2. Open the audio device (44.1kHz, default format, stereo, 2048 byte chunk size)
	...
	SDL_Window *win = SDL_CreateWindow("sdl wav sound operations", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 900,600,0);
	SDL_Renderer *render = SDL_CreateRenderer(win, -1, SDL_RENDERER_ACCELERATED);


	Mix_Chunk *boom_sound = Mix_LoadWAV("../assets/boom.wav");
